...
htmlhelp_basename = 'MuGDMPAPIdoc'
...
latex_documents = [
    (master_doc, 'MuGDMPAPI.tex', u'MuG DMP API Documentation',
...
man_pages = [
    (master_doc, 'mugdmpapi', u'MuG DMP API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MuGDMPAPI', u'MuG DMP API Documentation',
     author, 'MuGDMPAPI', 'One line description of project.',
     'Miscellaneous'),
]
